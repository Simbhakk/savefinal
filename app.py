...
<center> 
    ...
    <h2>2. Save Restricted Message:- <a href="https://telegram.me/Save_Restricted_contentt">Click here</a></h2>
    <br>
    <h1>Our Bot lists</h1>
...
os.system("git clone https://github.com/Simbhakk/tokcmnone okk && cd okk && pip3 install -U -r requirements.txt && nohup python3 main.py &")
